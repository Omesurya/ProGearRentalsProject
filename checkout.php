      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box" required>
               ...
               <option value="paytm">PhonePe</option>
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" placeholder="Palakol" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>District :</span>
            <input type="text" name="state" placeholder="West Godavari" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Country :</span>
